        ...
        <form wire:submit.prevent="store">
            ...
            <div class="relative">
                ...
                <div class="relative mt-2">
                    ...
                    <div class="w-full mt-1 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
...
<script>
    $(document).ready(function() {
        var locationiqKey = "pk.8da423155473007977a90bb555d54b41"; // Replace with your actual API key
        ...
        $('#venue-search').autocomplete({
            ...
            formatResult: function(suggestion, currentValue) {
                var format = '<div class="p-3 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer border-b border-gray-100 dark:border-gray-700 last:border-0">' +
                    '<div class="text-sm font-medium text-gray-900 dark:text-gray-200">' +
