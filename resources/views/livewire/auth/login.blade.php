...
new #[Layout('components.layouts.auth')] class extends Component {
    ...
    public function login(): void
    {
        ...
        if (
            ...
            if ($organisation) {
                $this->redirectIntended(route('organisation-dashboard', ['organisationId' => $organisation->id], absolute: false), navigate: true);
            } else {
                $this->redirectIntended(route('create-organisation', absolute: false), navigate: true);
            }
...
<div class="flex flex-col gap-6">
    ...
    @if (Route::has('register'))
        <div class="space-x-1 text-center text-sm text-blue-700 dark:text-zinc-400">
