            ...
            <div class="ticket-body">
                ...
                <div class="ticket-details">
                    <div class="venue-info">
                        ...
                        <p class="venue-name">{{ $event->venue ?: 'Online Event' }},
                ...
                <!-- Right side: QR code -->
                <div class="qr-code">
                    @if (isset($attendee->qrCode) && $attendee->qrCode)
                        <img src="{{ $attendee->qrCode }}" alt="QR Code">
                    @else
                        <div
                            style="width: 160px; height: 160px; border: 1px solid #e2e8f0; padding: 8px; background: white; display: flex; align-items: center; justify-content: center;">
